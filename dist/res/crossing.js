...
function findWasmBinary() {
  return locateFile('crossing.wasm');
}
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['restore_puzzle_size'] != 'undefined', 'missing Wasm export: restore_puzzle_size');
  assert(typeof wasmExports['mousedown'] != 'undefined', 'missing Wasm export: mousedown');
  assert(typeof wasmExports['mouseup'] != 'undefined', 'missing Wasm export: mouseup');
  assert(typeof wasmExports['mousemove'] != 'undefined', 'missing Wasm export: mousemove');
  assert(typeof wasmExports['key'] != 'undefined', 'missing Wasm export: key');
  assert(typeof wasmExports['dlg_return_sval'] != 'undefined', 'missing Wasm export: dlg_return_sval');
  assert(typeof wasmExports['dlg_return_ival'] != 'undefined', 'missing Wasm export: dlg_return_ival');
  ...
  _restore_puzzle_size = Module['_restore_puzzle_size'] = createExportWrapper('restore_puzzle_size', wasmExports['restore_puzzle_size'], 2);
  _mousedown = Module['_mousedown'] = createExportWrapper('mousedown', wasmExports['mousedown'], 3);
  _mouseup = Module['_mouseup'] = createExportWrapper('mouseup', wasmExports['mouseup'], 3);
  _mousemove = Module['_mousemove'] = createExportWrapper('mousemove', wasmExports['mousemove'], 3);
  _key = Module['_key'] = createExportWrapper('key', wasmExports['key'], 6);
  _dlg_return_sval = Module['_dlg_return_sval'] = createExportWrapper('dlg_return_sval', wasmExports['dlg_return_sval'], 2);
  _dlg_return_ival = Module['_dlg_return_ival'] = createExportWrapper('dlg_return_ival', wasmExports['dlg_return_ival'], 2);
